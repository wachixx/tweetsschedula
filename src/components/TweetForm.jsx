    ...
    useEffect(()=>{
     ...
     return(
        <form onSubmit={handleSubmit}>
            ...
            <textarea className="textarea" name="tweetText" onChange={handleInputChange}  defaultValue={state.tweet?.tweetText}></textarea>
            ...
            <div className="flex-row-btwn">
                <div className="textfield-wrapper">
                    <input className="textField" type="date"  name="tweetDate" onChange={handleInputChange} defaultValue={state.tweet?.tweetDate}></input>
                    {errors.tweetDate && <p className="error-message">{errors.tweetDate}</p>}
                </div>
                <div className="textfield-wrapper">
                    <input className="textField" type="time" name="tweetTime" onChange={handleInputChange} defaultValue={state.tweet?.tweetTime}></input>
